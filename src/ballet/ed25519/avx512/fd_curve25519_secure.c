...
fd_ed25519_point_add_secure( fd_ed25519_point_t *       restrict r,
  ...
  (void)tmp0;
  (void)tmp1;
  FD_R52X5_GE_ADD_TABLE( r->P, a->P, b->P );
}
...
fd_ed25519_point_neg_if( fd_ed25519_point_t * FD_RESTRICT r,
  ...
  r->P0 = wl_sub_if( -secret_cond, lo, a->P0, a->P0 );              
  r->P1 = wl_sub_if( -secret_cond, hi, a->P1, a->P1 );              
  r->P2 = wl_sub_if( -secret_cond, hi, a->P2, a->P2 );              
  r->P3 = wl_sub_if( -secret_cond, hi, a->P3, a->P3 );              
  r->P4 = wl_sub_if( -secret_cond, hi, a->P4, a->P4 );   
